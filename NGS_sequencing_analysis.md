...
A number of SNP databases exist. [dbSNP]() via NCBI is the largest database of SNPs, MNPs, and short indels. [SNPEffect]() focuses on predicting the impact of SNPs on the structural phenotype of proteins (ex protein stability & folding). [SNPedia]() is a wiki that collects information from publications on known SNPs and their clinical effects. The [1000 Genomes Browser]() and [Variation Viewer]() are good resources for visualizing SNPs. [ClinVar]() is a good resource for curated variations that have possible medical and clinical relevance.
